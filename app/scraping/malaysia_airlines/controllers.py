...
from app.scraping.malaysia_airlines.malaysia_service import *
from app.scraping.malaysia_airlines.services import *

class MalaysiaController:
    ...
    def get_booking_details(payload):
        ...
        try:
            ...
            ingestion = MalaysiaIngestionService(result, ci_id)
