...
from app.scraping.azerbaijan_airlines.azerbaijan_service import *
from app.scraping.azerbaijan_airlines.services import *

class AzerbaijanController:
    ...
    def get_booking_details(payload):
        ...
        try:
            ...
            ingestion = AzalIngestionService(result, ci_id)
